...
class TestNodesImportResponse(unittest.TestCase):
    """NodesImportResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NodesImportResponse:
        """Test NodesImportResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NodesImportResponse`
        """
        model = NodesImportResponse()
        if include_optional:
            return NodesImportResponse(
                node_ids = [
                    ''
                    ],
                total = 56
    ...
    def testNodesImportResponse(self):
        """Test NodesImportResponse"""
