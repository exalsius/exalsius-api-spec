    ...
    def make_instance(self, include_optional) -> ClusterResponse:
        ...
        if include_optional:
            return ClusterResponse(
                cluster = exalsius_api_client.models.cluster.cluster(
                    id = 123, 
                    name = 'my-cluster', 
                    ...
                    control_plane_node_ids = [123e4567-e89b-12d3-a456-426614174000], 
                    worker_node_ids = [123e4567-e89b-12d3-a456-426614174000, 123e4567-e89b-12d3-a456-426614174001], 
                    service_deployments = [{service_id=ffd4c2f4-ec48-41f1-be56-52ba90f661b6, service_name=my-service, values={key=value}}, {service_id=ffd4c2f4-ec48-41f1-be56-52ba90f661b7, service_name=my-service-2, values={key=value}}], 
                    k8s_version = '1.32.0', 
                    current_costs = 100, 
                    costs_per_hour = 1, )
            )
