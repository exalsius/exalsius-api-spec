...
class TestSshKeyCreateResponse(unittest.TestCase):
    """SshKeyCreateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SshKeyCreateResponse:
        """Test SshKeyCreateResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SshKeyCreateResponse`
        """
        model = SshKeyCreateResponse()
        if include_optional:
    ...
    def testSshKeyCreateResponse(self):
        """Test SshKeyCreateResponse"""
