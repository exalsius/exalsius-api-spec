...
class NodesApi:
    ...
    def list_nodes(
        self,
        node_type: Annotated[Optional[StrictStr], Field(description="Only return nodes of this type.   Possible values: - `self-managed` - only self-managed (SSH) nodes   - `cloud` - only cloud-imported nodes ")] = None,
        provider: Annotated[Optional[StrictStr], Field(description="Only return nodes of this provider. Example: - `aws` - only AWS node instances ")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
