...
class ClustersApi:
    ...
    def delete_cluster(
        self,
        cluster_id: Annotated[StrictInt, Field(description="ID of the cluster to delete")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def describe_cluster(
        self,
        cluster_id: Annotated[StrictInt, Field(description="ID of the cluster to describe")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def get_cluster_kubeconfig(
        self,
        cluster_id: Annotated[StrictInt, Field(description="The ID of the cluster to get the kubeconfig for")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def get_nodes(
        self,
        cluster_id: Annotated[StrictInt, Field(description="ID of the cluster to retrieve nodes from")],
        node_role: Annotated[Optional[StrictStr], Field(description="Only return nodes of this role. Possible values: - `control_plane` - only control plane nodes - `worker` - only worker nodes ")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def list_clusters(
        self,
        status: Annotated[Optional[StrictStr], Field(description="Only return clusters of this status. Possible values: - `pending` - clusters that are pending - `running` - clusters that are running - `deleting` - clusters that are deleting - `deleted` - clusters that are deleted - `failed` - clusters that failed ")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
