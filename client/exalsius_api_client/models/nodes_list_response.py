...
class NodesListResponse(BaseModel):
    ...
    total: Optional[StrictInt] = Field(default=None, description="The total number of nodes in the node pool")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "nodes": [BaseNode.from_dict(_item) for _item in obj["nodes"]] if obj.get("nodes") is not None else None,
            "total": obj.get("total")
        })
        return _obj
