...
class ServiceDeployment(BaseModel):
    ...
    ServiceDeployment
    """ # noqa: E501
    service_id: StrictStr = Field(description="The ID of the service")
    service_name: Optional[StrictStr] = Field(default=None, description="The name of the service")
    values: Optional[Dict[str, Any]] = Field(default=None, description="The values to set for the service")
