...
class NodeImportSshRequest(BaseModel):
    ...
    ssh_key_id: StrictStr = Field(description="The ID of the SSH key to use for the node")
    __properties: ClassVar[List[str]] = ["endpoint", "username", "description", "ssh_key_id"]
