...
class SelfManagedNode(BaseModel):
    ...
    endpoint: StrictStr = Field(description="The endpoint of the node (IP or hostname) and port")
    username: StrictStr = Field(description="The username to connect to the node")
    ssh_key_id: StrictStr = Field(description="The ID of the private SSH key to connect to the node")
    __properties: ClassVar[List[str]] = ["id", "node_type", "description", "location", "gpu_count", "gpu_vendor", "gpu_type", "gpu_memory", "cpu_cores", "memory_gb", "storage_gb", "import_time", "node_status", "endpoint", "username", "ssh_key_id"]
