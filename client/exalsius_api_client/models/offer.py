...
class Offer(BaseModel):
    ...
    availability_zone: StrictStr = Field(description="The availability zone of the offer")
    ...
    price_per_hour: Union[StrictFloat, StrictInt] = Field(description="The price per hour for the offer")
    scrape_time: datetime = Field(description="The time the offer was scraped")
    __properties: ClassVar[List[str]] = ["id", "provider", "location", "region", "availability_zone", "instance_type", "gpu_count", "gpu_vendor", "gpu_type", "gpu_memory", "price_per_hour", "scrape_time"]
