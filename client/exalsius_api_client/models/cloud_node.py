...
class CloudNode(BaseModel):
    ...
    location: StrictStr = Field(description="The location of the node (e.g. city, data center, server rack, etc.)")
    gpu_count: Optional[StrictInt] = Field(default=None, description="The number of GPUs")
    gpu_vendor: Optional[StrictStr] = Field(default=None, description="The vendor of the GPU")
    gpu_type: Optional[StrictStr] = Field(default=None, description="The type of the GPU")
    gpu_memory: Optional[StrictInt] = Field(default=None, description="The memory of the GPU in GB")
    cpu_cores: Optional[StrictInt] = Field(default=None, description="The number of CPU cores")
    memory_gb: Optional[StrictInt] = Field(default=None, description="The memory of the node in GB")
    storage_gb: Optional[StrictInt] = Field(default=None, description="The storage of the node in GB")
    import_time: Optional[datetime] = Field(default=None, description="The time the node was imported")
    ...
    availability_zone: Optional[StrictStr] = Field(default=None, description="The availability zone of the node")
    instance_type: StrictStr = Field(description="The instance type of the node")
    price_per_hour: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The price per hour for the node")
    __properties: ClassVar[List[str]] = ["id", "node_type", "description", "location", "gpu_count", "gpu_vendor", "gpu_type", "gpu_memory", "cpu_cores", "memory_gb", "storage_gb", "import_time", "node_status", "provider", "region", "availability_zone", "instance_type", "price_per_hour"]
