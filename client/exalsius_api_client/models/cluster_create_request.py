...
class ClusterCreateRequest(BaseModel):
    ...
    to_be_deleted_at: Optional[datetime] = Field(default=None, description="The date and time the cluster will be deleted (optional).")
    control_plane_node_ids: Optional[List[StrictStr]] = Field(default=None, description="The IDs of the control plane nodes (optional).")
    worker_node_ids: Optional[List[StrictStr]] = Field(default=None, description="The IDs of the worker nodes (optional).")
    service_deployments: Optional[List[ServiceDeployment]] = Field(default=None, description="The services to deploy in the cluster (optional).")
    __properties: ClassVar[List[str]] = ["name", "k8s_version", "to_be_deleted_at", "control_plane_node_ids", "worker_node_ids", "service_deployments"]
