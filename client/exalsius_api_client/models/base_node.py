...
class BaseNode(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "node_type", "description", "location", "gpu_count", "gpu_vendor", "gpu_type", "gpu_memory", "cpu_cores", "memory_gb", "storage_gb", "import_time", "node_status"]
