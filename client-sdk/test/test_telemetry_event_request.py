...
class TestTelemetryEventRequest(unittest.TestCase):
    """TelemetryEventRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TelemetryEventRequest:
        """Test TelemetryEventRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TelemetryEventRequest`
        """
        model = TelemetryEventRequest()
        if include_optional:
    ...
    def testTelemetryEventRequest(self):
        """Test TelemetryEventRequest"""
