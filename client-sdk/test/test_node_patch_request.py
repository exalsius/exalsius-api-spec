...
class TestNodePatchRequest(unittest.TestCase):
    """NodePatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NodePatchRequest:
        """Test NodePatchRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NodePatchRequest`
        """
        model = NodePatchRequest()
        if include_optional:
