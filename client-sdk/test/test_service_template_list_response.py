...
class TestServiceTemplateListResponse(unittest.TestCase):
    """ServiceTemplateListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceTemplateListResponse:
        """Test ServiceTemplateListResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ServiceTemplateListResponse`
        """
        model = ServiceTemplateListResponse()
        if include_optional:
            return ServiceTemplateListResponse(
                service_templates = [
                    exalsius_api_client.models.service_template.service-template(
    ...
    def testServiceTemplateListResponse(self):
        """Test ServiceTemplateListResponse"""
