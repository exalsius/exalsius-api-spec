...
class TestKubeconfig(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Kubeconfig:
        """Test Kubeconfig
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `Kubeconfig`
        """
        model = Kubeconfig()
        if include_optional:
            return Kubeconfig(
...
clusters:
  - cluster:
    ...
    name: exalsius-cluster
contexts:
  - context:
      cluster: exalsius-cluster
      user: exalsius-user
    name: exalsius-context
current-context: exalsius-context
kind: Config
preferences: {}
'
            )
