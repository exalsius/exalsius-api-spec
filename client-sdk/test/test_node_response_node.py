...
class TestNodeResponseNode(unittest.TestCase):
    """NodeResponseNode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NodeResponseNode:
        """Test NodeResponseNode
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NodeResponseNode`
        """
        model = NodeResponseNode()
        if include_optional:
            return NodeResponseNode(
