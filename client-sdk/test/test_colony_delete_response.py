...
class TestColonyDeleteResponse(unittest.TestCase):
    """ColonyDeleteResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ColonyDeleteResponse:
        """Test ColonyDeleteResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ColonyDeleteResponse`
        """
        model = ColonyDeleteResponse()
        if include_optional:
            return ColonyDeleteResponse(
                colony_id = '123e4567-e89b-12d3-a456-426614174000',
                cluster_ids = [123e4567-e89b-12d3-a456-426614174000, 123e4567-e89b-12d3-a456-426614174001]
            )
        else:
            return ColonyDeleteResponse(
                colony_id = '123e4567-e89b-12d3-a456-426614174000',
    ...
    def testColonyDeleteResponse(self):
        """Test ColonyDeleteResponse"""
