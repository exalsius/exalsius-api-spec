...
class TestColonyKubeconfigResponse(unittest.TestCase):
    """ColonyKubeconfigResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ColonyKubeconfigResponse:
        """Test ColonyKubeconfigResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ColonyKubeconfigResponse`
        """
        model = ColonyKubeconfigResponse()
        if include_optional:
            return ColonyKubeconfigResponse(
                kubeconfig = 'apiVersion: v1
clusters:
  - cluster:
      server: https://api.exalsius.ai/clusters/123e4567-e89b-12d3-a456-426614174000
users:
  - name: user
    user:
      token: "123"
...
',
    ...
    def testColonyKubeconfigResponse(self):
        """Test ColonyKubeconfigResponse"""
