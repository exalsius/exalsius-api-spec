...
class TestClusterNodeRemoveResponse(unittest.TestCase):
    """ClusterNodeRemoveResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClusterNodeRemoveResponse:
        """Test ClusterNodeRemoveResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ClusterNodeRemoveResponse`
        """
        model = ClusterNodeRemoveResponse()
        if include_optional:
            return ClusterNodeRemoveResponse(
    ...
    def testClusterNodeRemoveResponse(self):
        """Test ClusterNodeRemoveResponse"""
