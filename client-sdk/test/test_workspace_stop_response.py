...
class TestWorkspaceStopResponse(unittest.TestCase):
    """WorkspaceStopResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkspaceStopResponse:
        """Test WorkspaceStopResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `WorkspaceStopResponse`
        """
        model = WorkspaceStopResponse()
        if include_optional:
    ...
    def testWorkspaceStopResponse(self):
        """Test WorkspaceStopResponse"""
