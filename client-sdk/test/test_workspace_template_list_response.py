...
class TestWorkspaceTemplateListResponse(unittest.TestCase):
    """WorkspaceTemplateListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkspaceTemplateListResponse:
        """Test WorkspaceTemplateListResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `WorkspaceTemplateListResponse`
        """
        model = WorkspaceTemplateListResponse()
        if include_optional:
            return WorkspaceTemplateListResponse(
                workspace_templates = [
                    exalsius_api_client.models.workspace_template.workspace-template(
    ...
    def testWorkspaceTemplateListResponse(self):
        """Test WorkspaceTemplateListResponse"""
