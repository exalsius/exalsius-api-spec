...
class TestSshKeysListResponse(unittest.TestCase):
    """SshKeysListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SshKeysListResponse:
        """Test SshKeysListResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SshKeysListResponse`
        """
        model = SshKeysListResponse()
        if include_optional:
            return SshKeysListResponse(
                ssh_keys = [
                    exalsius_api_client.models.ssh_keys_list_response_ssh_keys_inner.ssh_keys_list_response_ssh_keys_inner(
    ...
    def testSshKeysListResponse(self):
        """Test SshKeysListResponse"""
