...
class TestServiceDeploymentCreateResponse(unittest.TestCase):
    """ServiceDeploymentCreateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceDeploymentCreateResponse:
        """Test ServiceDeploymentCreateResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ServiceDeploymentCreateResponse`
        """
        model = ServiceDeploymentCreateResponse()
        if include_optional:
            return ServiceDeploymentCreateResponse(
                service_deployment_id = '123e4567-e89b-12d3-a456-426614174000'
            )
        else:
            return ServiceDeploymentCreateResponse(
                service_deployment_id = '123e4567-e89b-12d3-a456-426614174000',
    ...
    def testServiceDeploymentCreateResponse(self):
        """Test ServiceDeploymentCreateResponse"""
