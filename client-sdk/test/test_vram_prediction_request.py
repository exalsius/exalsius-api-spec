...
class TestVramPredictionRequest(unittest.TestCase):
    """VramPredictionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VramPredictionRequest:
        """Test VramPredictionRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `VramPredictionRequest`
        """
        model = VramPredictionRequest()
        if include_optional:
            return VramPredictionRequest(
                model = '',
                batch_size = 1,
                sequence_length = 1
            )
    ...
    def testVramPredictionRequest(self):
        """Test VramPredictionRequest"""
