    ...
    def make_instance(self, include_optional) -> ClusterCreateRequest:
        ...
        if include_optional:
            return ClusterCreateRequest(
                ...
                worker_node_ids = [123e4567-e89b-12d3-a456-426614174000],
                service_deployments = [{service_id=ffd4c2f4-ec48-41f1-be56-52ba90f661b6, service_name=my-service, values={key=value}}]
            )
        else:
            return ClusterCreateRequest(
                name = 'my-cluster',
