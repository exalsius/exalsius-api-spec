...
class TestColonyCreateRequest(unittest.TestCase):
    """ColonyCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ColonyCreateRequest:
        """Test ColonyCreateRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ColonyCreateRequest`
        """
        model = ColonyCreateRequest()
        if include_optional:
            return ColonyCreateRequest(
                name = 'my-colony'
            )
        else:
            return ColonyCreateRequest(
    ...
    def testColonyCreateRequest(self):
        """Test ColonyCreateRequest"""
