...
class TestWorkspaceAccessInformation(unittest.TestCase):
    """WorkspaceAccessInformation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkspaceAccessInformation:
        """Test WorkspaceAccessInformation
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `WorkspaceAccessInformation`
        """
        model = WorkspaceAccessInformation()
        if include_optional:
            return WorkspaceAccessInformation(
                access_type = 'NODE_PORT',
                port_name = 'http',
                port_description = 'Connects with the jupyter notebook UI.',
                protocol = 'HTTP',
    ...
    def testWorkspaceAccessInformation(self):
        """Test WorkspaceAccessInformation"""
