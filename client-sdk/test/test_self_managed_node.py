...
class TestSelfManagedNode(unittest.TestCase):
    """SelfManagedNode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SelfManagedNode:
        """Test SelfManagedNode
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SelfManagedNode`
        """
        model = SelfManagedNode()
        if include_optional:
