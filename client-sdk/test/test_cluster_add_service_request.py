...
class TestClusterAddServiceRequest(unittest.TestCase):
    """ClusterAddServiceRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClusterAddServiceRequest:
        """Test ClusterAddServiceRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ClusterAddServiceRequest`
        """
        model = ClusterAddServiceRequest()
        if include_optional:
            return ClusterAddServiceRequest(
                service_deployments = [
                    exalsius_api_client.models.service_deployment.service-deployment(
    ...
    def testClusterAddServiceRequest(self):
        """Test ClusterAddServiceRequest"""
