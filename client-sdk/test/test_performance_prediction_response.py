...
class TestPerformancePredictionResponse(unittest.TestCase):
    """PerformancePredictionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PerformancePredictionResponse:
        """Test PerformancePredictionResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PerformancePredictionResponse`
        """
        model = PerformancePredictionResponse()
        if include_optional:
            return PerformancePredictionResponse(
                performance_prediction = exalsius_api_client.models.performance_prediction.performance-prediction(
    ...
    def testPerformancePredictionResponse(self):
        """Test PerformancePredictionResponse"""
