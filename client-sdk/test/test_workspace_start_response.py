...
class TestWorkspaceStartResponse(unittest.TestCase):
    """WorkspaceStartResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkspaceStartResponse:
        """Test WorkspaceStartResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `WorkspaceStartResponse`
        """
        model = WorkspaceStartResponse()
        if include_optional:
    ...
    def testWorkspaceStartResponse(self):
        """Test WorkspaceStartResponse"""
