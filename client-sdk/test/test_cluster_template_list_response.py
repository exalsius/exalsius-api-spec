...
class TestClusterTemplateListResponse(unittest.TestCase):
    """ClusterTemplateListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClusterTemplateListResponse:
        """Test ClusterTemplateListResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ClusterTemplateListResponse`
        """
        model = ClusterTemplateListResponse()
        if include_optional:
            return ClusterTemplateListResponse(
                cluster_templates = [
                    exalsius_api_client.models.cluster_template.cluster-template(
                        name = 'my-cluster-template', 
                        description = 'These are credentials for the AWS cloud provider', 
                        k8s_version = '1.30.0', )
                    ],
                total = 56
            )
    ...
    def testClusterTemplateListResponse(self):
        """Test ClusterTemplateListResponse"""
