...
class TestClusterEventPayload(unittest.TestCase):
    """ClusterEventPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClusterEventPayload:
        """Test ClusterEventPayload
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ClusterEventPayload`
        """
        model = ClusterEventPayload()
        if include_optional:
            return ClusterEventPayload(
                ...
                involved_object = exalsius_api_client.models.cluster_event_payload_involved_object.cluster_event_payload_involved_object(
                    kind = '', 
                    name = '', 
                    namespace = '', )
            )
    ...
    def testClusterEventPayload(self):
        """Test ClusterEventPayload"""
