...
class TestVramPredictionResponse(unittest.TestCase):
    """VramPredictionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VramPredictionResponse:
        """Test VramPredictionResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `VramPredictionResponse`
        """
        model = VramPredictionResponse()
        if include_optional:
            return VramPredictionResponse(
                total_vram = 24.5,
                model_vram = 2.5,
                optimizer_vram = 14,
                optimizer_intermediate_vram = 14,
                gradients_vram = 2,
                activations_vram = 2
            )
        else:
    ...
    def testVramPredictionResponse(self):
        """Test VramPredictionResponse"""
