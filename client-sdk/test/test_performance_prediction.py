...
class TestPerformancePrediction(unittest.TestCase):
    """PerformancePrediction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PerformancePrediction:
        """Test PerformancePrediction
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PerformancePrediction`
        """
    ...
    def testPerformancePrediction(self):
        """Test PerformancePrediction"""
