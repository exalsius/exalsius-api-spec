...
class TestClusterCreateResponse(unittest.TestCase):
    """ClusterCreateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClusterCreateResponse:
        """Test ClusterCreateResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ClusterCreateResponse`
        """
        model = ClusterCreateResponse()
        if include_optional:
    ...
    def testClusterCreateResponse(self):
        """Test ClusterCreateResponse"""
