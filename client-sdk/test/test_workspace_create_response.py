...
class TestWorkspaceCreateResponse(unittest.TestCase):
    """WorkspaceCreateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkspaceCreateResponse:
        """Test WorkspaceCreateResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `WorkspaceCreateResponse`
        """
        model = WorkspaceCreateResponse()
        if include_optional:
    ...
    def testWorkspaceCreateResponse(self):
        """Test WorkspaceCreateResponse"""
