...
class TestClusterEventPayloadInvolvedObject(unittest.TestCase):
    """ClusterEventPayloadInvolvedObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClusterEventPayloadInvolvedObject:
        """Test ClusterEventPayloadInvolvedObject
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ClusterEventPayloadInvolvedObject`
        """
        model = ClusterEventPayloadInvolvedObject()
        if include_optional:
            return ClusterEventPayloadInvolvedObject(
                kind = '',
                name = '',
                namespace = ''
            )
    ...
    def testClusterEventPayloadInvolvedObject(self):
        """Test ClusterEventPayloadInvolvedObject"""
