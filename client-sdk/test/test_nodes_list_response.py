...
class TestNodesListResponse(unittest.TestCase):
    """NodesListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NodesListResponse:
        """Test NodesListResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NodesListResponse`
        """
        model = NodesListResponse()
        if include_optional:
            return NodesListResponse(
                nodes = [
                    exalsius_api_client.models.base_node.base-node(
                        id = 123e4567-e89b-12d3-a456-426614174000, 
                        node_type = 'CLOUD', 
                        description = 'My self-managed / cloud node', 
                        location = 'Virginia', 
                        gpu_count = 1, 
                        gpu_vendor = 'nvidia', 
                        gpu_type = 'a100', 
                        ...
                        memory_gb = 16, 
                        storage_gb = 100, 
                        import_time = '2021-01-01T00:00:00Z', 
    ...
    def testNodesListResponse(self):
        """Test NodesListResponse"""
