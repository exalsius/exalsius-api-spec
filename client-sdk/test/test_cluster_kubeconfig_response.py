...
class TestClusterKubeconfigResponse(unittest.TestCase):
    """ClusterKubeconfigResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClusterKubeconfigResponse:
        """Test ClusterKubeconfigResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ClusterKubeconfigResponse`
        """
        model = ClusterKubeconfigResponse()
        if include_optional:
            return ClusterKubeconfigResponse(
...
',
    ...
    def testClusterKubeconfigResponse(self):
        """Test ClusterKubeconfigResponse"""
