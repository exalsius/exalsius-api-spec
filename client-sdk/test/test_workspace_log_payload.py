...
class TestWorkspaceLogPayload(unittest.TestCase):
    """WorkspaceLogPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkspaceLogPayload:
        """Test WorkspaceLogPayload
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `WorkspaceLogPayload`
        """
        model = WorkspaceLogPayload()
        if include_optional:
            return WorkspaceLogPayload(
                pod_name = '',
                pod_namespace = '',
    ...
    def testWorkspaceLogPayload(self):
        """Test WorkspaceLogPayload"""
