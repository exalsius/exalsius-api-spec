...
class TestNodePatchResponse(unittest.TestCase):
    """NodePatchResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NodePatchResponse:
        """Test NodePatchResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NodePatchResponse`
        """
        model = NodePatchResponse()
        if include_optional:
    ...
    def testNodePatchResponse(self):
        """Test NodePatchResponse"""
