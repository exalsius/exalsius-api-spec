...
class TestNodeAgentDeploymentConfiguration(unittest.TestCase):
    """NodeAgentDeploymentConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NodeAgentDeploymentConfiguration:
        """Test NodeAgentDeploymentConfiguration
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NodeAgentDeploymentConfiguration`
        """
        model = NodeAgentDeploymentConfiguration()
        if include_optional:
            return NodeAgentDeploymentConfiguration(
    ...
    def testNodeAgentDeploymentConfiguration(self):
        """Test NodeAgentDeploymentConfiguration"""
