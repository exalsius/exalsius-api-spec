...
class TestClusterLocalStorage(unittest.TestCase):
    """ClusterLocalStorage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClusterLocalStorage:
        """Test ClusterLocalStorage
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ClusterLocalStorage`
        """
        model = ClusterLocalStorage()
        if include_optional:
            return ClusterLocalStorage(
                enabled = True,
    ...
    def testClusterLocalStorage(self):
        """Test ClusterLocalStorage"""
