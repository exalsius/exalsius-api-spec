...
class TestServiceResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ServiceResponse:
        """Test ServiceResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ServiceResponse`
        """
        model = ServiceResponse()
        if include_optional:
            return ServiceResponse(
                service_deployment = exalsius_api_client.models.service.service(
