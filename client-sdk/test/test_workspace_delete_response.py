...
class TestWorkspaceDeleteResponse(unittest.TestCase):
    """WorkspaceDeleteResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkspaceDeleteResponse:
        """Test WorkspaceDeleteResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `WorkspaceDeleteResponse`
        """
        model = WorkspaceDeleteResponse()
        if include_optional:
    ...
    def testWorkspaceDeleteResponse(self):
        """Test WorkspaceDeleteResponse"""
