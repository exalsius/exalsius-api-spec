...
class TestServiceDeleteResponse(unittest.TestCase):
    """ServiceDeleteResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceDeleteResponse:
        """Test ServiceDeleteResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ServiceDeleteResponse`
        """
        model = ServiceDeleteResponse()
        if include_optional:
    ...
    def testServiceDeleteResponse(self):
        """Test ServiceDeleteResponse"""
