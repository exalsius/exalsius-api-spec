...
class TestServiceDeploymentDeleteResponse(unittest.TestCase):
    """ServiceDeploymentDeleteResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceDeploymentDeleteResponse:
        """Test ServiceDeploymentDeleteResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ServiceDeploymentDeleteResponse`
        """
        model = ServiceDeploymentDeleteResponse()
        if include_optional:
            return ServiceDeploymentDeleteResponse(
    ...
    def testServiceDeploymentDeleteResponse(self):
        """Test ServiceDeploymentDeleteResponse"""
