...
class TestColoniesListResponse(unittest.TestCase):
    """ColoniesListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ColoniesListResponse:
        """Test ColoniesListResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ColoniesListResponse`
        """
        model = ColoniesListResponse()
        if include_optional:
            return ColoniesListResponse(
                colonies = [
                    exalsius_api_client.models.colony.colony(
    ...
    def testColoniesListResponse(self):
        """Test ColoniesListResponse"""
