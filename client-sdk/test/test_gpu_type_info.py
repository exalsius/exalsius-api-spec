...
class TestGpuTypeInfo(unittest.TestCase):
    """GpuTypeInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GpuTypeInfo:
        """Test GpuTypeInfo
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `GpuTypeInfo`
        """
        model = GpuTypeInfo()
        if include_optional:
            return GpuTypeInfo(
