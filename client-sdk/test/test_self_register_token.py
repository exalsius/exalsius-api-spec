...
class TestSelfRegisterToken(unittest.TestCase):
    """SelfRegisterToken unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SelfRegisterToken:
        """Test SelfRegisterToken
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SelfRegisterToken`
        """
        model = SelfRegisterToken()
        if include_optional:
            return SelfRegisterToken(
    ...
    def testSelfRegisterToken(self):
        """Test SelfRegisterToken"""
