...
class TestClusterDeployResponse(unittest.TestCase):
    """ClusterDeployResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClusterDeployResponse:
        """Test ClusterDeployResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ClusterDeployResponse`
        """
        model = ClusterDeployResponse()
        if include_optional:
    ...
    def testClusterDeployResponse(self):
        """Test ClusterDeployResponse"""
