...
class TestClusterAdoptRequest(unittest.TestCase):
    """ClusterAdoptRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClusterAdoptRequest:
        """Test ClusterAdoptRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ClusterAdoptRequest`
        """
        model = ClusterAdoptRequest()
        if include_optional:
            return ClusterAdoptRequest(
                name = 'my-cluster',
                colony_id = '123e4567-e89b-12d3-a456-426614174000',
                kubeconfig_b64 = '123e4567-e89b-12d3-a456-426614174000',
                k8s_version = '1.30'
            )
        else:
            return ClusterAdoptRequest(
    ...
    def testClusterAdoptRequest(self):
        """Test ClusterAdoptRequest"""
