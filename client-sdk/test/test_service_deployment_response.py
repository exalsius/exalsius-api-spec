...
class TestServiceDeploymentResponse(unittest.TestCase):
    """ServiceDeploymentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceDeploymentResponse:
        """Test ServiceDeploymentResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ServiceDeploymentResponse`
        """
        model = ServiceDeploymentResponse()
        if include_optional:
            return ServiceDeploymentResponse(
                service_deployment = exalsius_api_client.models.service_deployment.service-deployment(
                    id = '123e4567-e89b-12d3-a456-426614174000', 
                    name = 'my-service-deployment', 
                    cluster_id = '123e4567-e89b-12d3-a456-426614174000', 
                    template = exalsius_api_client.models.service_template.service-template(
                        name = 'my-service-template', 
                        description = 'This service template configures the Ray Deployment', 
                        variables = {ray_cluster_name=my-ray-cluster}, ), 
                    owner = 'John Doe', 
                    description = 'This is a description of my service deployment', 
    ...
    def testServiceDeploymentResponse(self):
        """Test ServiceDeploymentResponse"""
