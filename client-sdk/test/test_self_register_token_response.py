...
class TestSelfRegisterTokenResponse(unittest.TestCase):
    """SelfRegisterTokenResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SelfRegisterTokenResponse:
        """Test SelfRegisterTokenResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SelfRegisterTokenResponse`
        """
        model = SelfRegisterTokenResponse()
        if include_optional:
            return SelfRegisterTokenResponse(
    ...
    def testSelfRegisterTokenResponse(self):
        """Test SelfRegisterTokenResponse"""
