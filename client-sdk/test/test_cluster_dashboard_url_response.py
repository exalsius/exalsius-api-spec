...
class TestClusterDashboardUrlResponse(unittest.TestCase):
    """ClusterDashboardUrlResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClusterDashboardUrlResponse:
        """Test ClusterDashboardUrlResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ClusterDashboardUrlResponse`
        """
        model = ClusterDashboardUrlResponse()
        if include_optional:
            return ClusterDashboardUrlResponse(
                url = 'https://grafana.exalsius.ai/c/my-cluster/t/my-token/dashboards'
            )
        else:
            return ClusterDashboardUrlResponse(
                url = 'https://grafana.exalsius.ai/c/my-cluster/t/my-token/dashboards',
    ...
    def testClusterDashboardUrlResponse(self):
        """Test ClusterDashboardUrlResponse"""
