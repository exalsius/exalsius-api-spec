...
class TestClusterNodesResponse(unittest.TestCase):
    """ClusterNodesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClusterNodesResponse:
        """Test ClusterNodesResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ClusterNodesResponse`
        """
        model = ClusterNodesResponse()
        if include_optional:
    ...
    def testClusterNodesResponse(self):
        """Test ClusterNodesResponse"""
