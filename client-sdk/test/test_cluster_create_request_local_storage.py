...
class TestClusterCreateRequestLocalStorage(unittest.TestCase):
    """ClusterCreateRequestLocalStorage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClusterCreateRequestLocalStorage:
        """Test ClusterCreateRequestLocalStorage
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ClusterCreateRequestLocalStorage`
        """
        model = ClusterCreateRequestLocalStorage()
        if include_optional:
            return ClusterCreateRequestLocalStorage(
                enabled = True,
    ...
    def testClusterCreateRequestLocalStorage(self):
        """Test ClusterCreateRequestLocalStorage"""
