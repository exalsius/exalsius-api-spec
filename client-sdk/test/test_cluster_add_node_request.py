...
class TestClusterAddNodeRequest(unittest.TestCase):
    """ClusterAddNodeRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClusterAddNodeRequest:
        """Test ClusterAddNodeRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ClusterAddNodeRequest`
        """
        model = ClusterAddNodeRequest()
        if include_optional:
            return ClusterAddNodeRequest(
                nodes_to_add = [
                    exalsius_api_client.models.cluster_node_to_add.cluster-node-to-add(
    ...
    def testClusterAddNodeRequest(self):
        """Test ClusterAddNodeRequest"""
