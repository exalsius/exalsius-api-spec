...
class TestSshKeysListResponseSshKeysInner(unittest.TestCase):
    """SshKeysListResponseSshKeysInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SshKeysListResponseSshKeysInner:
        """Test SshKeysListResponseSshKeysInner
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SshKeysListResponseSshKeysInner`
        """
        model = SshKeysListResponseSshKeysInner()
        if include_optional:
            return SshKeysListResponseSshKeysInner(
    ...
    def testSshKeysListResponseSshKeysInner(self):
        """Test SshKeysListResponseSshKeysInner"""
