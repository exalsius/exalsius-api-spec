...
class TestDashboardUrlResponse(unittest.TestCase):
    """DashboardUrlResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DashboardUrlResponse:
        """Test DashboardUrlResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DashboardUrlResponse`
        """
        model = DashboardUrlResponse()
        if include_optional:
            return DashboardUrlResponse(
                url = 'https://grafana.exalsius.ai/t/my-token/login'
            )
        else:
            return DashboardUrlResponse(
                url = 'https://grafana.exalsius.ai/t/my-token/login',
    ...
    def testDashboardUrlResponse(self):
        """Test DashboardUrlResponse"""
