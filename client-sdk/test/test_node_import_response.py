...
class TestNodeImportResponse(unittest.TestCase):
    """NodeImportResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NodeImportResponse:
        """Test NodeImportResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NodeImportResponse`
        """
        model = NodeImportResponse()
        if include_optional:
    ...
    def testNodeImportResponse(self):
        """Test NodeImportResponse"""
