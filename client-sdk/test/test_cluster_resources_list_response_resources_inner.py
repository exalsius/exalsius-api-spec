...
class TestClusterResourcesListResponseResourcesInner(unittest.TestCase):
    """ClusterResourcesListResponseResourcesInner unit test stubs"""
    ...
    def make_instance(
        ...
        """Test ClusterResourcesListResponseResourcesInner
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ClusterResourcesListResponseResourcesInner`
        """
        model = ClusterResourcesListResponseResourcesInner()
        if include_optional:
            return ClusterResourcesListResponseResourcesInner(
    ...
    def testClusterResourcesListResponseResourcesInner(self):
        """Test ClusterResourcesListResponseResourcesInner"""
