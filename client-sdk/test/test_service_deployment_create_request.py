...
class TestServiceDeploymentCreateRequest(unittest.TestCase):
    """ServiceDeploymentCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceDeploymentCreateRequest:
        """Test ServiceDeploymentCreateRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ServiceDeploymentCreateRequest`
        """
        model = ServiceDeploymentCreateRequest()
        if include_optional:
    ...
    def testServiceDeploymentCreateRequest(self):
        """Test ServiceDeploymentCreateRequest"""
