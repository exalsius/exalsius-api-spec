...
class TestColonyCreateResponse(unittest.TestCase):
    """ColonyCreateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ColonyCreateResponse:
        """Test ColonyCreateResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ColonyCreateResponse`
        """
        model = ColonyCreateResponse()
        if include_optional:
    ...
    def testColonyCreateResponse(self):
        """Test ColonyCreateResponse"""
