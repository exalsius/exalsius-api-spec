...
class TestNodeDeleteResponse(unittest.TestCase):
    """NodeDeleteResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NodeDeleteResponse:
        """Test NodeDeleteResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NodeDeleteResponse`
        """
        model = NodeDeleteResponse()
        if include_optional:
    ...
    def testNodeDeleteResponse(self):
        """Test NodeDeleteResponse"""
