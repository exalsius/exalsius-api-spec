...
class TestClusterServicesResponse(unittest.TestCase):
    """ClusterServicesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClusterServicesResponse:
        """Test ClusterServicesResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ClusterServicesResponse`
        """
        model = ClusterServicesResponse()
        if include_optional:
    ...
    def testClusterServicesResponse(self):
        """Test ClusterServicesResponse"""
