...
class TestWorkspaceDeployment(unittest.TestCase):
    """WorkspaceDeployment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkspaceDeployment:
        """Test WorkspaceDeployment
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `WorkspaceDeployment`
        """
        model = WorkspaceDeployment()
        if include_optional:
            return WorkspaceDeployment(
                workspace_id = '123e4567-e89b-12d3-a456-426614174000',
                workspace_name = 'my-juypter-notebook',
                workspace_template = 'my-juypter-notebook',
                owner = 'John-Doe'
            )
        else:
            return WorkspaceDeployment(
    ...
    def testWorkspaceDeployment(self):
        """Test WorkspaceDeployment"""
