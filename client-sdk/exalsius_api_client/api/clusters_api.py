...
class ClustersApi:
    ...
    def get_cluster_dashboards(
        self,
        cluster_id: Annotated[
            StrictStr, Field(description="ID of the cluster to get dashboards for")
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        **Retrieve the dashboards for a cluster**  Enables access to observability dashboards for a specific cluster. Each dashboard provides a visual representation  of cluster performance metrics, resource utilization, and operational insights.

        :param cluster_id: ID of the cluster to get dashboards for (required)
        :type cluster_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_cluster_dashboards_serialize(
            cluster_id=cluster_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_cluster_dashboards_with_http_info(
        self,
        cluster_id: Annotated[
            StrictStr, Field(description="ID of the cluster to get dashboards for")
        ],
    ...
    @validate_call
    def get_cluster_dashboards_without_preload_content(
        self,
        cluster_id: Annotated[
            StrictStr, Field(description="ID of the cluster to get dashboards for")
        ],
    ...
    def _get_cluster_dashboards_serialize(
        self,
        cluster_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/cluster/{cluster_id}/dashboards",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
