...
class ManagementApi:
    ...
    def get_dashboard_auth(
        ...
        **Retrieve the dashboard authentication**  Enables access to observability dashboards for all clusters the user has access to. Each dashboard provides a visual representation  of cluster performance metrics, resource utilization, and operational insights.
    ...
    def get_dashboard_url(
        ...
        **Retrieve the URL to Grafana dashboards for all clusters the user has access to**  Returns the URL to Grafana dashboards for all clusters the user has access to.
