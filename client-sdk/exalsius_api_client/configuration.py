...
class Configuration:
    ...
    conf = exalsius_api_client.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor"""
        self._base_path = "https://api.exalsius.ai/v1" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("exalsius_api_client")
    ...
    def to_debug_report(self) -> str:
        ...
        return (
            ...
            "SDK Package Version: 1.1.3".format(env=sys.platform, pyversion=sys.version)
        )
