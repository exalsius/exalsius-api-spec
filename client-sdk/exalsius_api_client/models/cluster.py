...
class Cluster(BaseModel):
    ...
    cluster_annotations: Optional[Dict[str, StrictStr]] = Field(
        default=None, description="The annotations of the cluster (optional)."
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "cluster_annotations": obj.get("cluster_annotations"),
