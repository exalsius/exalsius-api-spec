...
class WorkspaceDeployment(BaseModel):
    """
    WorkspaceDeployment
    """  # noqa: E501
    ...
    workspace_template: StrictStr = Field(
        description="The name of the workspace template"
    )
    owner: StrictStr = Field(description="The owner of the workspace")
        ...
        _obj = cls.model_validate(
            {
                ...
                "workspace_template": obj.get("workspace_template"),
                "owner": obj.get("owner"),
            }
        )
        return _obj
