...
class NodeSystem(BaseModel):
    ...
    os: Optional[StrictStr] = Field(
        default=None, description="The operating system running on the node"
    )
    kernel: Optional[StrictStr] = Field(default=None, description="The kernel version")
    __properties: ClassVar[List[str]] = ["os", "kernel"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"os": obj.get("os"), "kernel": obj.get("kernel")})
        return _obj
