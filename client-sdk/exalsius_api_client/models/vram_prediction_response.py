...
class VramPredictionResponse(BaseModel):
    """
    VramPredictionResponse
    """  # noqa: E501

    total_vram: Union[StrictFloat, StrictInt] = Field(
        description="The total predicted vram"
    )
    model_vram: Union[StrictFloat, StrictInt] = Field(
        description="The vram used by the model"
    )
    optimizer_vram: Union[StrictFloat, StrictInt] = Field(
        description="The vram used by the optimizer"
    )
    optimizer_intermediate_vram: Union[StrictFloat, StrictInt] = Field(
        description="The vram used by the optimizer intermediate"
    )
    gradients_vram: Union[StrictFloat, StrictInt] = Field(
        description="The vram used by the optimizer"
    )
    activations_vram: Union[StrictFloat, StrictInt] = Field(
        description="The vram used by the activations"
    )
    __properties: ClassVar[List[str]] = [
        "total_vram",
        "model_vram",
        "optimizer_vram",
        "optimizer_intermediate_vram",
        "gradients_vram",
        "activations_vram",
    ]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "total_vram": obj.get("total_vram"),
                "model_vram": obj.get("model_vram"),
                "optimizer_vram": obj.get("optimizer_vram"),
                "optimizer_intermediate_vram": obj.get("optimizer_intermediate_vram"),
                "gradients_vram": obj.get("gradients_vram"),
                "activations_vram": obj.get("activations_vram"),
            }
        )
        return _obj
