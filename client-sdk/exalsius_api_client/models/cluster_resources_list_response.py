...
class ClusterResourcesListResponse(BaseModel):
    """
    ClusterResourcesListResponse
    """  # noqa: E501

    resources: List[ClusterResourcesListResponseResourcesInner]
    total: Optional[StrictInt] = Field(
        default=None,
        description="The total number of available / occupied resources in the cluster",
    )
    __properties: ClassVar[List[str]] = ["resources", "total"]
        ...
        _obj = cls.model_validate(
            {
                "resources": (
                    [
                        ClusterResourcesListResponseResourcesInner.from_dict(_item)
