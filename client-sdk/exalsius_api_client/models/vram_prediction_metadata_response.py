...
class VramPredictionMetadataResponse(BaseModel):
    """
    VramPredictionMetadataResponse
    """  # noqa: E501

    models: List[StrictStr] = Field(
        description="Distinct LLM models which are available for prediction."
    )
    batch_size_min: StrictInt = Field(description="Minimum batch size.")
    batch_size_max: StrictInt = Field(description="Maximum batch size.")
    sequence_length_min: StrictInt = Field(description="Minimum sequence length.")
    sequence_length_max: StrictInt = Field(description="Maximum sequence length.")
        ...
        _obj = cls.model_validate(
            {
                ...
                "batch_size_min": obj.get("batch_size_min"),
                "batch_size_max": obj.get("batch_size_max"),
                "sequence_length_min": obj.get("sequence_length_min"),
                "sequence_length_max": obj.get("sequence_length_max"),
            }
        )
        return _obj
