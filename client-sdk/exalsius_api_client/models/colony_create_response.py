...
class ColonyCreateResponse(BaseModel):
    ...
    colony_id: StrictStr = Field(description="The ID of the created colony")
    __properties: ClassVar[List[str]] = ["colony_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"colony_id": obj.get("colony_id")})
        return _obj
