...
class TelemetryEventRequest(BaseModel):
    ...
    event_name: StrictStr = Field(description="The telemetry event name.")
    additional_properties: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["event_name", "additional_properties"]
