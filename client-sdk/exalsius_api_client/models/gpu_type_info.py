...
class GpuTypeInfo(BaseModel):
    ...
    gpu_type: StrictStr = Field(description="Normalized GPU type identifier.")
    gpu_vendor: StrictStr = Field(
        description="The vendor/manufacturer for the GPU type."
    )
    __properties: ClassVar[List[str]] = ["gpu_type", "gpu_vendor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"gpu_type": obj.get("gpu_type"), "gpu_vendor": obj.get("gpu_vendor")}
        )
        return _obj
