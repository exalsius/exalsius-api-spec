...
class SelfRegisterToken(BaseModel):
    """
    SelfRegisterToken
    """  # noqa: E501

    register_token: StrictStr = Field(
        description="The token used by a node agent to call `POST /node/self-register`."
    )
    owner: StrictStr = Field(description="The owner of the token")
    org_namespace: StrictStr = Field(
        description="The organization namespace of the token"
    )
    __properties: ClassVar[List[str]] = ["register_token", "owner", "org_namespace"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "register_token": obj.get("register_token"),
                "owner": obj.get("owner"),
                "org_namespace": obj.get("org_namespace"),
            }
        )
        return _obj
