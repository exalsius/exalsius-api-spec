...
class PerformancePredictionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["performance_prediction"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of performance_prediction
        if self.performance_prediction:
            _dict["performance_prediction"] = self.performance_prediction.to_dict()
        return _dict
        ...
        _obj = cls.model_validate(
            {
                "performance_prediction": (
                    PerformancePrediction.from_dict(obj["performance_prediction"])
                    if obj.get("performance_prediction") is not None
                    else None
                )
            }
        )
